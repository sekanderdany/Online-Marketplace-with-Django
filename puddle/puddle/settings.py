...
SECRET_KEY = 'django-insecure-d39=!1fr1ggn55)v4ty54luj*ss(h)(^h9ftliz@d&t6)y)y2='
...
INSTALLED_APPS = [
    ...
    'conversation',  # Custom app for conversation management
    'core',  # Custom app for core functionality
    'item',  # Custom app for item management
